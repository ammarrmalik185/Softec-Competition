        ...
        window.confirmationResult.confirm(OTPInput)
            .then(function (result) {
                ...
                Promise.all([
                    ...
                    setDoc(doc(collection(db, "patients"), phoneNumber), user)
                ]).then(function (doc) {
    ...
    return (
        <div>
            <div className="flex h-screen" style={{
                ...
                <div className="loginFormBackground shadow-lg">
                    <div className="loginFormModelContainer">
                        ...
                        <div className="loginFormSingleFieldContainer">
                            <h1 style={{fontSize: 30, marginTop: 0, fontFamily: "sans-serif"}}>Sign up as a <span style={{color: "blue"}}>Patient</span></h1>
                        </div>
                        <div className="loginFormSingleFieldContainer">
                        ...
                        <div className="loginFormSingleFieldContainer">
                            <label className='loginFormLabel'>Address</label>
                            <textarea
                                value={address}
